...
function renderHistory(){
  ...
  const realRange = Number.isFinite(globalAvg) && globalAvg > 0 ? (BATTERY_KWH / globalAvg) * 100 : NaN;
  ...
  if ($("realRange")) $("realRange").textContent = Number.isFinite(realRange) ? fmtKm(realRange) : "—";
